export const BOXES=[[-24,3,0,2,6,52,'wall'],[24,3,0,2,6,52,'wall'],[0,3,-26,50,6,2,'wall'],[0,3,26,50,6,2,'wall'],[-10,1.6,-9,6,3.2,12,'blue'],[10,1.6,9,6,3.2,12,'red'],[9,1.6,-13,11,3.2,5,'olive'],[-9,1.6,13,11,3.2,5,'olive'],[0,1.2,0,4,2.4,5,'crate'],[-18,1,3,3,2,3,'crate'],[18,1,-3,3,2,3,'crate'],[2,1,-19,3,2,3,'crate'],[-2,1,19,3,2,3,'crate'],[0,.65,-9,4.5,1.3,1.2,'barrier'],[0,.65,9,4.5,1.3,1.2,'barrier']];
...
export function groundDistance(o,d){return d[1]<-1e-6?-o[1]/d[1]:Infinity}
export function wallDistance(o,d){return Math.min(groundDistance(o,d),...BOXES.map(b=>rayBox(o,d,[b[0]-b[3]/2,b[1]-b[4]/2,b[2]-b[5]/2],[b[0]+b[3]/2,b[1]+b[4]/2,b[2]+b[5]/2])))}
