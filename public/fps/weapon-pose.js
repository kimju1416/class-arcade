...
export const RIGS={
 rifle:{scale:.6,hip:[.115,-.115,-.55],hipRot:[.02,-.055,.03],sight:{x:0,y:.135},adsZ:-.30,adsFov:52,bob:1,kick:.075,rise:.045,mag:{x:0,y:-.085,z:.015}},
 sniper:{scale:.6,hip:[.112,-.122,-.58],hipRot:[.025,-.05,.035],sight:{x:0,y:.135},adsZ:-.30,adsFov:26,bob:.8,kick:.14,rise:.085,mag:{x:0,y:-.07,z:.03}}
};
